...
public class ClarkProfileActivity extends MainMapsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_clark_profile, null);
        send = v.findViewById(R.id.message_button);
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Need to send messages
                startActivity(new Intent(ClarkProfileActivity.this, message_screen.class));
            }
        });

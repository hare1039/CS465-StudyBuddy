...
public class PeoReqTabs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peo_req_tabs);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_peo_req_tabs, menu);
        return true;
    }
    ...
    public static class ReqFrag extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
         ...
         * number.
         */
        public static ReqFrag newInstance(int sectionNumber) {
            ReqFrag fragment = new ReqFrag();
            Bundle args = new Bundle();
            args.putInt(ARG_SECTION_NUMBER, sectionNumber);
            fragment.setArguments(args);
            return fragment;
